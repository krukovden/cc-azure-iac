...
variable waypoints_func_name_template {
  default = "func-cc-cp-waypoints-api-adapter-%s"
}

variable "waypoints_apim_api_params" {
  default = {
    name        = "abs-cc-waypoints-adapters-api"
    path        = "waypointsadapters"
    displayName = "Waypoints API"
    revision    = "1"
