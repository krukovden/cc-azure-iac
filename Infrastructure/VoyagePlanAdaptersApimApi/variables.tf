...
variable voyageplan_func_name_template {
  default = "func-cc-cp-voyage-plan-api-adapter-%s"
}

variable voyageplan_apim_api_params {
  default = {
    name        = "abs-cc-voyage-plan-adapters-api"
    path        = "voyageplanadapters"
    displayName = "Voyage Plan API"
    revision    = "1"
    description = "Voyage Plan API"
    protocols   = ["https"]
  }
}
